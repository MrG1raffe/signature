...
@dataclass
class Black76(AnalyticModel, CharacteristicFunctionModel):
    sigma: float
    ...
    def quadratic_variation(
        ...
        """
        Computes the quadratic variation <log F>_T at t = T.

        :param T: the date the quadratic variation to be calculated on.
        :return: the value of numerical approximation of <log F>_T.
        """
